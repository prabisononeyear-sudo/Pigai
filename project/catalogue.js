...
// Used by the Services page, Pricing page and the Ask Pig advisor. In production this file runs server-side
// so the language model can only *propose* ids; prices are always calculated here, deterministically.
